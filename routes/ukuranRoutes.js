...
router.post('/', isAuthenticated, hasPrivilege(['admin', 'owner']), ukuranController.createUkuran);
router.put('/:id', isAuthenticated, hasPrivilege(['admin', 'owner']), ukuranController.updateUkuran);
router.delete('/:id', isAuthenticated, hasPrivilege(['admin', 'owner']), ukuranController.deleteUkuran);
