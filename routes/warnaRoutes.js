...
router.post('/', isAuthenticated, hasPrivilege(['admin', 'owner', 'staff_gudang']), warnaController.createWarna);
router.put('/:id', isAuthenticated, hasPrivilege(['admin', 'owner', 'staff_gudang']), warnaController.updateWarna);
router.delete('/:id', isAuthenticated, hasPrivilege(['admin', 'owner', 'staff_gudang']), warnaController.deleteWarna);
