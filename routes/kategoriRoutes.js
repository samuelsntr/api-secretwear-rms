...
router.post('/', isAuthenticated, hasPrivilege(['admin', 'owner', 'staff_gudang']), kategoriController.createKategori);
router.put('/:id', isAuthenticated, hasPrivilege(['admin', 'owner', 'staff_gudang']), kategoriController.updateKategori);
router.delete('/:id', isAuthenticated, hasPrivilege(['admin', 'owner', 'staff_gudang']), kategoriController.deleteKategori);
