...
router.post('/', isAuthenticated, hasPrivilege(['admin', 'owner']), storeController.create);
router.put('/:id', isAuthenticated, hasPrivilege(['admin', 'owner']), storeController.update);
router.delete('/:id', isAuthenticated, hasPrivilege(['admin', 'owner']), storeController.delete);
router.patch('/:id/toggle-status', isAuthenticated, hasPrivilege(['admin', 'owner']), storeController.toggleStatus);
