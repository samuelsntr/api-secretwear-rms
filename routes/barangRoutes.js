...
router.post('/', isAuthenticated, hasPrivilege(['admin', 'owner', 'staff_gudang']), barangController.createBarang);
router.put('/:id', isAuthenticated, hasPrivilege(['admin', 'owner', 'staff_gudang']), barangController.updateBarang);
router.delete('/:id', isAuthenticated, hasPrivilege(['admin', 'owner', 'staff_gudang']), barangController.deleteBarang);
