...
router.post('/', isAuthenticated, hasPrivilege(['admin', 'owner']), supplierController.createSupplier);
router.put('/:id', isAuthenticated, hasPrivilege(['admin', 'owner']), supplierController.updateSupplier);
router.delete('/:id', isAuthenticated, hasPrivilege(['admin', 'owner']), supplierController.deleteSupplier);
